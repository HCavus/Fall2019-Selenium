...
public class PropertiesExample {
    ...
    public void test(){
        ...
        System.out.println("browser name: "+browser); //chrome

        //i need the browser/url from properties file
        String pBrowser= ConfigurationReader.getProperty("browser");
        System.out.println("pBrowser: "+pBrowser); //chrome

        String pUrl=ConfigurationReader.getProperty("url");//
        System.out.println("pUrl: "+pUrl);// http://practice.cybertekschool.com
    }
    @Test
    public void test2(){
